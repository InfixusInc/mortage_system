...
//    private String hashedValueWithHighSecurity(String password, boolean isRegistration) {
    private String hashedValueWithHighSecurity(String password) {
        String value;
//        if (isRegistration)
...
//        else value = password;
    ...
    public String getFinalHashedPassword(String password) {
//        String hashedValue = hashedValueWithHighSecurity(password, isRegistration);
        String hashedValue = hashedValueWithHighSecurity(password);
//        if (isRegistration)
        new StringBuilder().append(randomKey).append(":").append(hashedValue);
        return hashedValue;
    }
}