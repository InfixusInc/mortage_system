...
public class CustomerStatusReport implements Initializable {
    ...
    public void buildData() {
        ...
        try {
            ...
            String SQL = "SELECT DISTINCT surname, firstname, nationalId, cellNumber, email FROM  applicants";
            //ResultSet
            ...
            for (int i = 0; i < set.getMetaData().getColumnCount(); i++) {
                ...
                column.setCellValueFactory((
                        Callback<TableColumn.CellDataFeatures<ObservableList<String>, String>, ObservableValue<String>>)
    ...
    public void basicReport(ActionEvent event) throws IOException{
