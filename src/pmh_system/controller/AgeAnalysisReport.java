...
public class AgeAnalysisReport implements Initializable {
    ...
    public void buildData() {
        ...
        try {
            ...
            String SQL = "SELECT DISTINCT surname, firstname, cellNumber, email, monthlySubscription FROM applicants";
            //ResultSet
